    ...
    <div className="space-y-5">
      <section className="grid gap-4 xl:grid-cols-[1.15fr_0.85fr]">
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-1">
          ...
          <Card className="border bg-card shadow-sm"><CardContent><div className="flex items-center justify-between"><div><p className="text-sm font-medium text-muted-foreground">Saídas registradas</p><p className="metric-number mt-3 text-3xl font-semibold">{totals.saida}</p><p className="mt-1 text-xs text-muted-foreground">unidades no histórico</p></div><span className="flex size-10 items-center justify-center rounded-lg border bg-muted text-orange-700 dark:text-orange-300"><ArrowUpFromLine className="size-4" /></span></div></CardContent></Card>
        </div>
      </section>
